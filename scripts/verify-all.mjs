...
const suites = [
  ...
  { name: 'Automatic member session delegation (SQL)', file: 'verify-member-sessions.mjs' },
  { name: 'Automatic member session page forwarding', file: 'verify-member-session-pages.mjs' },
